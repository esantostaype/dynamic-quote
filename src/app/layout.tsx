  ...
  return (
    <html lang="en">
      <body>
        <Providers>
          <Header/>
          <main className="relative z-30 flex flex-col h-screen gap-4 md:gap-8 xl:gap-12 max-w-6xl mx-auto p-4 md:p-8">
            <div className="flex items-center gap-8">
              <Image src="/images/iso.svg" width="27" height="32" alt="Dynamic Studio" className="hidden md:block xl:hidden"/>
              <StepperList/>
            </div>
            <div className="flex flex-1 overflow-y-auto border border-[rgba(255,255,255,0.16)] bg-[rgba(10,10,32,0.6)] backdrop-blur-xl rounded-2xl">
              { children }
            </div>
          </main>
